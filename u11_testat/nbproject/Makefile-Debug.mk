...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/Cygwin_4.x-Windows/u11_testat.exe

dist/Debug/Cygwin_4.x-Windows/u11_testat.exe: ${OBJECTFILES}
...
${OBJECTDIR}/htechoserv.o: nbproject/Makefile-${CND_CONF}.mk htechoserv.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/htechoserv.o htechoserv.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/Cygwin_4.x-Windows/u11_testat.exe
